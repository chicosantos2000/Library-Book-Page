...
<html lang="pt-pt">
      ...
      <div class="row"> 
        <div class="col-sm-8">
          ...
          <?php 
            ...
            $id = $_GET["id"];
            $sql_p = "SELECT livros.livros_id, livros.livros_titulo, livros.livros_autor, livros.livros_copias, assuntos.assuntos_nome FROM (livros INNER JOIN assuntos ON livros.assuntos_id=assuntos.assuntos_id) WHERE assuntos.assuntos_id=$id";
  ...
  <div class=\"card-body\">
    ...
    <a href=\"detalhe.php?id=" . $row ["livros_id"] . "\" class=\"btn btn-primary\">Ver mais</a>
  </div>
</div>";
}
}else {
